...
@PrimaryKeyClass
public class EventReviewKey implements Serializable {
    ...
    public EventReviewKey() {}

    public EventReviewKey(String eventId, String createdBy) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EventReviewKey that)) return false;
